    ...
    <div className="bg-slate-600 min-h-screen">
      <main className="flex flex-col items-center justify-center text-center py-16 px-8">
        ...
        <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
          ...
          <span className="font-bold">Tailwind CSS</span> et Next.js, où je vais
        ...
        <ul className="mt-8 list-inside list-disc text-left text-gray-700 dark:text-gray-200 font-mono">
          <Link href="/login">
            <li className="mb-4">
              Page de <strong>connexion</strong> pour accéder à votre compte.
            </li>
          </Link>
          <Link href="/forgot_password">
            <li className="mb-4">
              Page de <strong>mot de passe oublié</strong> pour récupérer votre
              mot de passe.
            </li>
          </Link>
          <Link href="/about_information">
            <li className="mb-4">
              Page d&apos;<strong>information</strong> avec des détails sur
              l&apos;application.
            </li>
          </Link>
        </ul>
      ...
      <footer className="flex justify-center py-4 bg-gray-800 text-white dark:bg-gray-900">
        <p className="text-sm">
          Powered by{" "}
          <Link href="https://nextjs.org" className="text-blue-400">
            Next.js
          </Link>{" "}
          and{" "}
          <Link href="https://tailwindcss.com" className="text-blue-400">
            Tailwind CSS
          </Link>
